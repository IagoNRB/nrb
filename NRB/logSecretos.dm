		...
		verb
			ArmEsp()
				...
				if(usr.LogSecretotaitrain)
					...
					usr.Frozen=0
					usr << output("Você parou de treinar Taijutsu no LogSecreto.","output2.sistema")
					spawn(600)
						usr.canLogSecretotaitrain=0
				else
					usr<<output("Você começa a Treinar Taijutsu no LogSecreto.","output2.sistema")
		...
		verb
			ArmEsp()
				...
				if(usr.LogSecretoarmtrain)
					...
					usr.Frozen=0
					usr << output("Você parou de treinar Armas no LogSecreto.","output2.sistema")
					spawn(600)
						usr.canLogSecretoarmtrain=0
				else
					usr<<output("Você começa a Treinar Armas no LogSecreto.","output2.sistema")
		...
		verb
			GenEsp()
				...
				if(usr.LogSecretogentrain)
					...
					usr.Frozen=0
					usr << output("Você parou de Treinar Genjutsu no LogSecreto.","output2.sistema")
					spawn(600)
						usr.canLogSecretogentrain=0
				else
					usr<<output("Você começa a Treinar Genjutsu no LogSecreto.","output2.sistema")
		...
		verb
			NinEsp()
				...
				if(usr.LogSecretonintrain)
					...
					usr.Frozen=0
					usr << output("Você parou de Treinar Ninjutsu no LogSecreto.","output2.sistema")
					spawn(600)
						usr.canLogSecretonintrain=0
				else
					usr<<output("Você começa a Treinar Ninjutsu no LogSecreto.","output2.sistema")
